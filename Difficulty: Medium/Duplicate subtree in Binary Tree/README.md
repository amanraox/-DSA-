<h2><a href="https://www.geeksforgeeks.org/problems/duplicate-subtree-in-binary-tree/1?page=1&difficulty=Medium&status=unsolved&sortBy=submissions">Duplicate subtree in Binary Tree</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree, find out whether it&nbsp;contains a duplicate sub-tree of size two&nbsp;or more, or not.</span></p>
